...
insert overwrite table dim_sku partition(ds='20250918')
select
    sku.id,
    sku.price,
    sku.sku_name,
...
insert overwrite table dim_coupon partition(ds='20250918')
select
    id,
    coupon_name,
    coupon_type,
...
insert overwrite table dim_activity partition(ds='20250918')
select
    rule.id,
    info.id,
    activity_name,
...
insert overwrite table dim_province partition(ds='20250918')
select
    province.id,
    province.name,
    province.area_code,
...
insert overwrite table dim_promotion_pos partition(ds='20250918')
select
    `id`,
    `pos_location`,
    `pos_type`,
...
insert overwrite table dim_promotion_refer partition(ds='20250918')
select
    `id`,
    `refer_name`,
    `create_time`,
